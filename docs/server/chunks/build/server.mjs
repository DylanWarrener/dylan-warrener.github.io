import { defineComponent as defineComponent$1, shallowRef, warn, reactive, watchEffect, toRef, inject as inject$1, computed, toValue, Fragment, capitalize, getCurrentInstance as getCurrentInstance$1, provide, ref, unref, hasInjectionContext, toRaw, watch, onScopeDispose, h, Suspense, createVNode, effectScope, shallowReactive, mergeProps, createElementVNode, normalizeClass, createElementBlock, cloneVNode, defineAsyncComponent, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isRef, isShallow, isReactive, getCurrentScope, withCtx, toRefs, nextTick, useSSRContext } from 'vue';
import { i as createError$1, k as klona, l as defuFn, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, q as sanitizeStatusCode, r as getContext, $ as $fetch$1, v as baseURL, x as createHooks, y as executeAsync, z as toRouteMatcher, A as createRouter$1, B as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B-jyTrSv.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./index-C6mNqZp7.mjs')
  },
  {
    name: "skills",
    path: "/skills",
    component: () => import('./index-DBq-8ohn.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./index-BhrF9d3B.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-CCNBlAMr.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-CmbwL4p3.mjs').then((r) => r["default"] || r.default || r));
...
function vuetifyConfiguration() {
  const options = { "theme": { "defaultTheme": "light", "themes": { "light": { "dark": false, "colors": { "primary": "#03a9f4", "secondary": "#1976d2", "default": "#000000", "inverted": "#ffffff" } }, "dark": { "dark": true, "colors": { "primary": "#03a9f4", "secondary": "#1976d2", "default": "#ffffff", "inverted": "#000000" } } } }, "typography": { "h1": { "size": "4rem", "weight": 700, "lineHeight": 1.2, "letterSpacing": "0em" }, "h2": { "size": "3.2rem", "weight": 700, "lineHeight": 1.2, "letterSpacing": "0em" }, "h3": { "size": "2.6rem", "weight": 700, "lineHeight": 1.2, "letterSpacing": "0em" }, "h4": { "size": "2rem", "weight": 700, "lineHeight": 1.2, "letterSpacing": "0em" }, "h5": { "size": "1.5rem", "weight": 700, "lineHeight": 1.2, "letterSpacing": "0em" }, "h6": { "size": "1.2rem", "weight": 700, "lineHeight": 1.2, "letterSpacing": "0em" }, "body1": { "size": "1.6rem", "weight": 400, "lineHeight": 1.5, "letterSpacing": "0em" }, "body2": { "size": "1.4rem", "weight": 400, "lineHeight": 1.5, "letterSpacing": "0em" }, "subtitle1": { "size": "1.6rem", "weight": 500, "lineHeight": 1.5, "letterSpacing": "0.00938em" }, "subtitle2": { "size": "1.4rem", "weight": 500, "lineHeight": 1.5, "letterSpacing": "0.00714em" }, "button": { "size": "1.4rem", "weight": 500, "lineHeight": 1.75, "letterSpacing": "0.0892857em", "textTransform": "uppercase" }, "caption": { "size": "1.2rem", "weight": 400, "lineHeight": 1.66, "letterSpacing": "0.03333em" }, "overline": { "size": "1.2rem", "weight": 400, "lineHeight": 2.66, "letterSpacing": "0.08333em", "textTransform": "uppercase" }, "info": { "size": "1.2rem", "weight": 400, "lineHeight": 1.5, "letterSpacing": "0em" } }, "autoImport": true, "ssr": true };
  return options;
}
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DC9X21dn.mjs').then((m) => m.default || m)),
  "temp-buttons": defineAsyncComponent(() => import('./temp-buttons-BzYJKyOr.mjs').then((m) => m.default || m)),
  "temp-sections": defineAsyncComponent(() => import('./temp-sections-TyShJ1uy.mjs').then((m) => m.default || m)),
  "temp-typography": defineAsyncComponent(() => import('./temp-typography-D3XKmcNb.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BnWrqz6S.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-dYxYKLAQ.mjs'));
...
export { templateRef as A, deepEqual as B, wrapInArray as C, consoleWarn as D, defer as E, includes as F, getCurrentInstanceName as G, destructComputed as H, IconValue as I, isCssColor as J, isParsableColor as K, parseColor as L, getForeground as M, useTheme as N, useIcon as O, flattenFragments as P, hasEvent as Q, keyCodes as R, isObject as S, onlyDefinedProps as T, _export_sfc as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry$1 as default, useRtl as e, breakpoints as f, genericComponent as g, getCurrentInstance as h, convertToUnit as i, asyncDataDefaults as j, createError as k, useAppConfig as l, findChildrenWithProvide as m, navigateTo as n, provideTheme as o, propsFactory as p, provideDefaults as q, resolveRouteObject as r, makeThemeProps as s, tryUseNuxtApp as t, useDisplay as u, clamp as v, useProxiedModel as w, useToggleScope as x, makeDisplayProps as y, __nuxt_component_2 as z };

...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Portfolio for showcasing my projects, skills, and knowledge."}],"link":[{"rel":"icon","href":"/favicon.ico"},{"key":"mdi","rel":"stylesheet","href":"https://cdn.jsdelivr.net/npm/@mdi/font@5.x/css/materialdesignicons.min.css","type":"text/css","crossorigin":"anonymous"}],"style":[],"script":[],"noscript":[],"titleTemplate":"DRWDev - %s","charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
